            ...
            do {
                ...
                switch (userChoice) {
                    ...
                    case 3:
                        ...
                        for (Vegetables vegetable: salads[2].getSaladComponents()) {
                            if (minCalories < vegetable.calPer100Grams && vegetable.calPer100Grams < maxCalories) {
                                System.out.println("\t" + vegetable.vegetableName + " : "
                                        + vegetable.calPer100Grams + " cal.");
                            }
                        }
